window.onload = function() {
		...
		function canvasResize() {
			ctx.width = $("#jstx").width();
			ctx.height = $("#jstx").height();
		}
		...
		drawDynamicLine(176, 108, 193, 51);
		drawDynamicLine(176, 108, 103, 52);
		drawDynamicLine(176, 108, 61, 102);
		drawDynamicLine(176, 108, 122, 142);
		
		drawDynamicLine(193, 53, 103, 52);
		drawDynamicLine(103, 52, 61, 102);
		drawDynamicLine(61, 102, 122, 142);
